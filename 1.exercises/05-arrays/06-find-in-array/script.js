...
(() => {
    ...
    document.getElementById("run").addEventListener("click", () => {
        const RechPers = people.findIndex(element => (element.firstname === 'Jean', element.lastname === 'Dupont') );
        people[RechPers]["index"]=RechPers;
        console.log(people[RechPers].email);
        console.log(people[RechPers]);
        });
})();
